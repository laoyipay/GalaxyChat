...
export declare type IAccessTokenSigner = import('@virgilsecurity/crypto-types').IAccessTokenSigner;
export declare type ICardCrypto = import('@virgilsecurity/crypto-types').ICardCrypto;
export declare type IPrivateKeyExporter = import('@virgilsecurity/crypto-types').IPrivateKeyExporter;
